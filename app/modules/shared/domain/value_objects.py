...
# Allowed characters for resource-style names (e.g. knowledge bases, API keys):
# letters (including accented), digits, spaces, hyphens, and underscores.
RESOURCE_NAME_PATTERN = re.compile(r"^[A-Za-zÀ-ÖØ-öø-ÿ0-9\s\-_]+$")
...
class Name:
    ...
    def __init__(
        self, first_name: str, last_name: str, preferred_name: str | None = None
    ) -> None:
        self.first_name = first_name
        self.last_name = last_name
        self.preferred_name = preferred_name if preferred_name else first_name
        self._normalize()
        self._validate()
